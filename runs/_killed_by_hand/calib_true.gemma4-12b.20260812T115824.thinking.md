# calib_true · gemma4:12b · 20260812T115824 — model reasoning
...
*   Constraint: "DECLARE every tool you hold. First line, before anything else."
    ...
    *   Tools declared first? Yes.
    ...
    Wait, let me re-read "K1...K6". These are internal logic rules for *me* to follow while processing. They aren't part of the output format, but they govern how I decide if something is VERIFIED or MISQUOTED.
    ...
    Quote: "The enclosure is rated IP54 and is not submersible."

    C2: "The unit draws 15 milliamps when the relay is open."
    S6: "The unit draws 15 milliamps when the relay is open."
    Quote: "The unit draws 15 milliamps when the relay is open."

    C3: "The firmware cannot be updated in the field."
    S9: "Firmware is written to flash at manufacture and cannot be updated in the field."
    Quote: "Firmware is written to flash at manufacture and cannot be updated in the field."

    Wait, I should check if there are any nuances.
    C